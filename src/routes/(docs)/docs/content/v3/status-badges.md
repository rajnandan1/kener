...
## Live Status (Dot) {#live-status-dot}
...
### 15 Minute Uptime {#15-minute-uptime}
...
### Custom Label {#custom-label-uptime}
...
### With Custom Value Color {#with-custom-value-color}
...
### With Both Different Colors {#with-both-different-colors}
...
### Style Of the Badge {#style-of-the-badge}
