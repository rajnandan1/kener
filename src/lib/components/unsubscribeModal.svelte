			...
			<div class="content px-4 py-4">
				...
				{:else}
					...
					<p class="text-xs text-muted-foreground">
						Unsubscribe from {incident.title} You'll stop receiving email notifications when
						this incident is updated.
					</p>
					...
					<div class="flex w-full items-center justify-center">
						<Button
							class="my-2 h-8 justify-center"
							on:click={() => unsubscribeSubscriber()}>Unsubscribe</Button
						>
					</div>
				{/if}
			</div>
