...
<DrawerPortal {...portalProps}>
	...
	<DrawerPrimitive.Content
		...
		class={cn(
			"group/drawer-content dark:bg-zinc-950 bg-white border-zinc-800 fixed z-50 flex h-auto flex-col",
	...
	>
		<div
			class="dark:bg-zinc-800 bg-zinc-200 mx-auto mt-4 hidden h-1.5 w-16 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block"
		></div>
		{@render children?.()}
	</DrawerPrimitive.Content>
</DrawerPortal>
