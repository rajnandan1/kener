import { c as create_ssr_component, f as compute_rest_props, g as spread, k as escape_attribute_value, h as escape_object, v as validate_component, b as add_attribute, e as escape, a as each } from './ssr-f056b9d4.js';
import { c as cn, i as is_void, C as Card, a as Card_content, I as Icon$1 } from './Icon-c4d21504.js';
import 'clsx';
import './ctx-0629e220.js';
import { R as Root, T as Trigger, H as Hover_card_content, a as Button } from './index4-03a346fb.js';
...
const Incident = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if (!!incidentClosedAt && !!incidentCreatedAt) {
    let diff = moment(incidentClosedAt * 1e3).add(1, "minutes").diff(moment(incidentCreatedAt * 1e3), "minutes");
    if (diff > 0) {
...
//# sourceMappingURL=incident-da7e9ce5.js.map
