...
import 'clsx';
import { I as Incident } from './incident-55ad4db5.js';
import { e as setCtx, f as getAttrs } from './ctx-0629e220.js';
import { c as cn } from './Icon-c4d21504.js';
import 'moment';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}` : `<div class="flex items-center justify-left" data-svelte-h="svelte-dr0k6a"><p class="text-xl">No active incidents</p></div>`}</div></section> ${validate_component(Separator, "Separator").$$render($$result, { class: "container mb-4 w-[400px]" }, {}, {})} <section class="mx-auto flex-1 mt-8 flex-col mb-4 flex w-full" id="active_incident"><div class="container"><h1 class="mb-4 text-2xl font-bold leading-none">${validate_component(Badge, "Badge").$$render($$result, { variant: "outline" }, {}, {
    default: () => {
  ...
  })}` : `<div class="flex items-center justify-left" data-svelte-h="svelte-b2l9ix"><p class="text-xl">No recent incidents</p></div>`}</div></section>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-f4ba4925.js.map
