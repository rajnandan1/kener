import { c as create_ssr_component, v as validate_component, e as escape, a as each, b as add_attribute } from './ssr-b88b7280.js';
import { d as derived, w as writable } from './index3-b13f1ade.js';
import { b as buttonVariants } from './index2-b1ce715f.js';
import { I as Icon$1 } from './ctx-0c900a31.js';
import 'clsx';
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<div class="one"></div> <header class="relative z-50 w-full "><div class="container flex h-14 items-center"><div class="mr-4 hidden md:flex blurry-bg "><a${add_attribute("href", data.site.home, 0)} class="mr-6 flex items-center space-x-2"><img${add_attribute("src", data.site.logo, 0)} class="h-5 w-5" alt="" srcset=""> <span class="hidden font-bold sm:inline-block text-[15px] lg:text-base">${escape(data.site.title)}</span></a> <nav class="flex items-center space-x-6 text-sm font-medium">${each(data.site.nav, (navItem) => {
...
//# sourceMappingURL=_layout.svelte-dbdc087e.js.map
