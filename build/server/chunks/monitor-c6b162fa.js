import { c as create_ssr_component, k as createEventDispatcher, b as add_attribute, e as escape, v as validate_component, a as each, f as compute_rest_props, d as subscribe, g as spread, h as escape_object } from './ssr-7290eec0.js';
import 'clsx';
import { a as Button, B as Badge } from './index4-752d1d90.js';
import { h as setCtx$2, i as getCtx$1, j as setCtx$1, k as getCtx, l as setItemCtx, m as getRadioIndicator, n as builder, o as getAttrs$3, p as getAttrs$2, q as getAttrs$1, r as addMeltEventListener } from './ctx-47f8ca86.js';
import { d as derived } from './index2-ce07ec2c.js';
import { c as createDispatcher } from './events-5cf2eb43.js';
import { b as buttonVariants } from './index3-358e23a7.js';
import { c as cn, f as flyAndScale, I as Icon$1 } from './Icon-3df2be2e.js';
...
const css = {
  code: ".daygrid90.svelte-ndieap.svelte-ndieap{-ms-overflow-style:none;scrollbar-width:none}.daygrid90.svelte-ndieap.svelte-ndieap::-webkit-scrollbar{display:none}.oneline.svelte-ndieap.svelte-ndieap{transition:transform 0.1s ease-in;cursor:pointer}.oneline.svelte-ndieap.svelte-ndieap:hover{transform:scaleY(1.2)}.oneline.svelte-ndieap:hover+.show-hover.svelte-ndieap{display:block !important}.show-hover.svelte-ndieap.svelte-ndieap{display:none;top:30px;padding:0px;text-align:left}.today-sq+.hiddenx.svelte-ndieap .message.svelte-ndieap{position:absolute;white-space:nowrap}.today-sq.svelte-ndieap+.hiddenx.svelte-ndieap{visibility:hidden;z-index:30}.today-sq.svelte-ndieap:hover+.hiddenx.svelte-ndieap{visibility:visible}.today-sq.svelte-ndieap.svelte-ndieap:hover{box-shadow:rgba(50, 50, 105, 0.15) 0px 2px 5px 0px, rgba(0, 0, 0, 0.05) 0px 1px 1px 0px;opacity:0.75;transition:all 0.1s ease-in;cursor:pointer}.today-sq.svelte-ndieap.svelte-ndieap{position:relative;z-index:0}",
  map: null
};
const Monitor = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="grid grid-cols-12 gap-4 monitor pb-4">${monitor.embed === void 0 ? `<div class="col-span-12 md:col-span-4"><div class="pt-1"><div class="scroll-m-20 text-2xl font-semibold tracking-tight">${monitor.image ? `<img${add_attribute("src", monitor.image, 0)} class="w-6 h-6 inline"${add_attribute("alt", monitor.name, 0)} srcset="">` : ``} <span>${escape(monitor.name)}</span> <br> ${monitor.description ? `${validate_component(Root, "Popover.Root").$$render($$result, {}, {}, {
      default: () => {
        return `${validate_component(Trigger, "Popover.Trigger").$$render($$result, {}, {}, {
          default: () => {
            return `<span class="${"pt-0 pl-1 menu-monitor pr-0 pb-0 " + escape(buttonVariants({ variant: "link" }), true) + " svelte-ndieap"}">${validate_component(Info$1, "Info").$$render($$result, { size: 12, class: "text-muted-foreground" }, {}, {})}</span>`;
          }
      ...
      default: () => {
        return `${validate_component(Trigger, "Popover.Trigger").$$render($$result, {}, {}, {
          default: () => {
            return `<span class="${"pt-0 pl-1 pb-0 menu-monitor pr-0 " + escape(buttonVariants({ variant: "link" }), true) + " svelte-ndieap"}">${validate_component(Share2, "Share2").$$render($$result, { size: 12, class: "text-muted-foreground" }, {}, {})}</span>`;
          }
          ...
          {},
          {
            default: () => {
              return `<h2 class="mb-1 text-lg font-semibold px-2" data-svelte-h="svelte-e3fjsq">Share</h2> <p class="pl-2 mb-2 text-muted-foreground text-sm" data-svelte-h="svelte-q5xjc3">Share this monitor using a link with others.</p> ${validate_component(Button, "Button").$$render($$result, { class: "ml-2", variant: "secondary" }, {}, {
                ...
                {
                  default: () => {
                    return `${`${validate_component(TrendingUp, "TrendingUp").$$render($$result, { class: "inline mr-2", size: 12 }, {}, {})} <span class="text-sm font-medium" data-svelte-h="svelte-y4ddl8">Status Badge</span>`}`;
                  }
                }
                ...
                {
                  default: () => {
                    return `${`${validate_component(Percent$1, "Percent").$$render($$result, { class: "inline mr-2", size: 12 }, {}, {})} <span class="text-sm font-medium" data-svelte-h="svelte-5noj4u">Uptime Badge</span>`}`;
                  }
                }
              )}`;
            }
    ...
    })}</div></div> <div class=""><div class="grid grid-cols-2 gap-0"><div class="col-span-1 -mt-2"><a href="${"/incident/" + escape(monitor.folderName, true) + "#past_incident"}" class="${"pt-0 pl-0 pb-0 text-indigo-500 text-left " + escape(buttonVariants({ variant: "link" }), true) + " svelte-ndieap"}">Recent Incidents ${validate_component(ArrowRight, "ArrowRight").$$render($$result, { size: 16 }, {}, {})}</a></div></div></div></div>` : ``} <div class="${"col-span-12 " + escape(monitor.embed === void 0 ? "md:col-span-8" : "", true) + " pt-2"}"><div class="grid grid-cols-12"><div class="${escape(
      ...
      true
    ) + " md:col-span-4 text-right h-[32px]"}">${_90Day[todayDD] ? `<div class="${"text-api-up " + escape(monitor.embed === void 0 ? "md:pr-6" : "", true) + " text-sm font-semibold mt-[4px] text-" + escape(_90Day[todayDD].cssClass, true) + " svelte-ndieap"}">${escape(_90Day[todayDD].message)}</div>` : ``}</div></div> <div class="grid grid-cols-12">${`<div class="chart-status relative mt-1 col-span-12"><div class="flex overflow-x-auto daygrid90 overflow-y-hidden py-1 svelte-ndieap">${each(Object.entries(_90Day), ([ts, bar]) => {
      return `<div class="h-[30px] w-[6px] rounded-sm oneline svelte-ndieap"><div class="${"h-[30px] bg-" + escape(bar.cssClass, true) + " w-[4px] rounded-sm mr-[2px] svelte-ndieap"}"></div></div> <div class="absolute show-hover text-sm bg-background svelte-ndieap"><div class="${"text-" + escape(bar.cssClass, true) + " font-semibold svelte-ndieap"}">${bar.message != "No Data" ? `● ${escape(new Date(bar.timestamp * 1e3).toLocaleDateString())} ${escape(bar.message)}` : `● ${escape(new Date(bar.timestamp * 1e3).toLocaleDateString())} ${escape(bar.message)}`}</div> </div>`;
    })}</div></div>`}</div></div> </div>`;
  } while (!$$settled);
  return $$rendered;
});
...
export { Monitor as M };
//# sourceMappingURL=monitor-c6b162fa.js.map
