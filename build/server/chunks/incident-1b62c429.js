      ...
      return `${validate_component(Card_header, "Card.Header").$$render($$result, {}, {}, {
        default: () => {
          return `${validate_component(Card_title, "Card.Title").$$render($$result, { class: "relative" }, {}, {
            ...
            default: () => {
              return `${escape(moment(incidentCreatedAt * 1e3).format("MMMM Do YYYY, h:mm:ss a"))} <p class="mt-2 leading-8">${incident.labels.includes("identified") ? `<span class="mt-1 text-xs font-semibold me-2 px-2.5 py-1 uppercase leading-3 inline-block rounded tag-indetified">${escape(l(lang, "incident.identified"))}</span>` : ``} ${incident.labels.includes("resolved") ? `<span class="text-xs font-semibold me-2 px-2.5 py-1 leading-3 inline-block rounded uppercase tag-resolved">${escape(l(lang, "incident.resolved"))}</span>` : ``} ${incident.labels.includes("maintenance") ? `<span class="text-xs font-semibold me-2 px-2.5 py-1 leading-3 inline-block rounded uppercase tag-maintenance">${escape(l(lang, "incident.maintenance"))}</span>` : ``}</p>`;
            }
          })}`;
        }
...
//# sourceMappingURL=incident-1b62c429.js.map
