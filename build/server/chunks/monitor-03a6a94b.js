...
import 'clsx';
import { R as Root, T as Trigger, H as Hover_card_content, a as Button, B as Badge } from './index4-03a346fb.js';
import { h as setCtx$1, i as getCtx, j as setItemCtx, k as getRadioIndicator, l as builder, m as getAttrs$2, n as getAttrs$1, o as addMeltEventListener } from './ctx-0629e220.js';
import { b as buttonVariants } from './index3-45856754.js';
import { c as cn, b as createDispatcher, I as Icon$1 } from './Icon-c4d21504.js';
  ...
  do {
    ...
    $$rendered = `<div class="grid grid-cols-12 gap-4 monitor pb-4 svelte-1cihxcj">${monitor.embed === void 0 ? `<div class="col-span-12 md:col-span-4"><div class="pt-1"><div class="scroll-m-20 text-2xl font-semibold tracking-tight">${monitor.image ? `<img${add_attribute("src", monitor.image, 0)} class="w-6 h-6 inline"${add_attribute("alt", monitor.name, 0)} srcset="">` : ``} ${escape(monitor.name)} ${monitor.description ? `${validate_component(Root, "HoverCard.Root").$$render($$result, {}, {}, {
      ...
      default: () => {
        ...
        })} ${validate_component(Hover_card_content, "HoverCard.Content").$$render($$result, { class: " pl-1 pr-1 pb-1 w-[375px]" }, {}, {
          default: () => {
