...
By default Kener runs at the root path (`/`). However, you can configure it to run under a custom URL subpath. Learn more about this setting [here](/docs/environment-vars/#kener-base-path).
